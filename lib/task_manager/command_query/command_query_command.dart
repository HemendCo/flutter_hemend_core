...
class CommandModel<T> {
  ...
  /// optional assertion test that will be run before running
  /// command to validate parameters given or other cases
  ///
  ...
  FutureOr<T> call(Parameters params, ResultTable results) async {
